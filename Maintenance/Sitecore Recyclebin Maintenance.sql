-----Delete recyclebin items older than @Days
DECLARE	@Temp int = 0
DECLARE	@Days int = 30
DECLARE	@ArchiveType nvarchar(30) = 'recyclebin'
DECLARE @DeleteDate DATETIME = DATEADD(DAY, -@Days, GETDATE())

/*
To delete the recyclebin items, records need to be removed from following tables,
